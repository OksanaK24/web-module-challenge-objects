...
console.log(createMenuItem("sushi",5,"dinner"))
console.log(createMenuItem("tea",5,"drinks"))
...
function getLongReviews(array) {
    let arrLongReviews = []
    for (let i = 0; i < array.length; i++){
      let subArr = array[i].feedback.split(" ")
      if(subArr.length > 15){
        arrLongReviews.push(array[i])
      }
    }
